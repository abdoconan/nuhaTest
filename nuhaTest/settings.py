"""
Django settings for nuhaTest project.
...
SECRET_KEY = 'django-insecure-)w0fmpu2th!_0*$!s86s*mw#a&(^p$95ogo1!$2p7mijni7xv5'
...
MIDDLEWARE = [
    ...
    'middlewares.middlewares.AuthinticationMiddleWare',
]

ROOT_URLCONF = 'nuhaTest.urls'
...
WSGI_APPLICATION = 'nuhaTest.wsgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': JSON_CONFIGRATION['ENGINE'],
        'NAME': os.path.join(BASE_DIR, JSON_CONFIGRATION['DATABASE_NAME']),
    }
}
